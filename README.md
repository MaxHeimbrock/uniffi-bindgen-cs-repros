...
Two independent, self-contained reproductions of bugs in the C# that
...
| folder    | bug                                                                                   | report |
|-----------|---------------------------------------------------------------------------------------|--------|
| `issue1/` | a custom type of another crate is never aliased in the consuming file (CS0246)        | [../UPSTREAM-external-custom-type-alias.md](../UPSTREAM-external-custom-type-alias.md) |
| `issue2/` | the converter of another crate's object is passed the wrong crate's `BigEndianStream` (CS1503) | [../UPSTREAM-external-object-converter-stream.md](../UPSTREAM-external-object-converter-stream.md) |
